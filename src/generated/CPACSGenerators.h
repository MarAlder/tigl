...
namespace generated
{
    ...
    /// 
    /// 
    class CPACSGenerators
    {
    public:
        TIGL_EXPORT CPACSGenerators(CPACSSystemElements* parent, CTiglUIDManager* uidMgr);

        TIGL_EXPORT virtual ~CPACSGenerators();
    ...
    protected:
        ...
        std::vector<std::unique_ptr<CPACSGenerator>> m_generators;

    private:
        CPACSGenerators(const CPACSGenerators&) = delete;
        CPACSGenerators& operator=(const CPACSGenerators&) = delete;

        CPACSGenerators(CPACSGenerators&&) = delete;
        CPACSGenerators& operator=(CPACSGenerators&&) = delete;
    };
} // namespace generated

// Aliases in tigl namespace
using CCPACSGenerators = generated::CPACSGenerators;
