...
namespace generated
{
    ...
    /// 
    /// 
    class CPACSGasTurbines
    {
    public:
        TIGL_EXPORT CPACSGasTurbines(CPACSSystemElements* parent, CTiglUIDManager* uidMgr);

        TIGL_EXPORT virtual ~CPACSGasTurbines();
    ...
    protected:
        ...
        std::vector<std::unique_ptr<CPACSGasTurbine>> m_gasTurbines;

    private:
        CPACSGasTurbines(const CPACSGasTurbines&) = delete;
        CPACSGasTurbines& operator=(const CPACSGasTurbines&) = delete;

        CPACSGasTurbines(CPACSGasTurbines&&) = delete;
        CPACSGasTurbines& operator=(CPACSGasTurbines&&) = delete;
    };
} // namespace generated

// Aliases in tigl namespace
using CCPACSGasTurbines = generated::CPACSGasTurbines;
