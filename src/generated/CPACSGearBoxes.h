...
namespace generated
{
    ...
    /// 
    /// 
    class CPACSGearBoxes
    {
    public:
        TIGL_EXPORT CPACSGearBoxes(CPACSSystemElements* parent, CTiglUIDManager* uidMgr);

        TIGL_EXPORT virtual ~CPACSGearBoxes();
    ...
    protected:
        ...
        std::vector<std::unique_ptr<CPACSGearBox>> m_gearBoxs;

    private:
        CPACSGearBoxes(const CPACSGearBoxes&) = delete;
        CPACSGearBoxes& operator=(const CPACSGearBoxes&) = delete;

        CPACSGearBoxes(CPACSGearBoxes&&) = delete;
        CPACSGearBoxes& operator=(CPACSGearBoxes&&) = delete;
    };
} // namespace generated

// Aliases in tigl namespace
using CCPACSGearBoxes = generated::CPACSGearBoxes;
