...
namespace generated
{
    ...
    protected:
        ...
        std::vector<std::unique_ptr<CPACSVehicleElementBase>> m_genericComponents;

    private:
        CPACSGenericComponents(const CPACSGenericComponents&) = delete;
        CPACSGenericComponents& operator=(const CPACSGenericComponents&) = delete;

        CPACSGenericComponents(CPACSGenericComponents&&) = delete;
        CPACSGenericComponents& operator=(CPACSGenericComponents&&) = delete;
    };
} // namespace generated
