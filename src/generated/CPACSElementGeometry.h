...
namespace generated
{
    ...
    public:
        ...
        TIGL_EXPORT virtual void RemoveExternalGeometry_choice4();

        TIGL_EXPORT virtual CPACSBoundingBox& GetBoundingBox_choice5(CreateIfNotExistsTag);
        TIGL_EXPORT virtual void RemoveBoundingBox_choice5();
