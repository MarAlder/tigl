...
namespace generated
{
    ...
    {
    public:
        TIGL_EXPORT CPACSHeatExchangers(CPACSSystemElements* parent, CTiglUIDManager* uidMgr);

        TIGL_EXPORT virtual ~CPACSHeatExchangers();
    ...
    protected:
        ...
        std::vector<std::unique_ptr<CPACSHeatExchanger>> m_heatExchangers;

    private:
        CPACSHeatExchangers(const CPACSHeatExchangers&) = delete;
        CPACSHeatExchangers& operator=(const CPACSHeatExchangers&) = delete;

        CPACSHeatExchangers(CPACSHeatExchangers&&) = delete;
        CPACSHeatExchangers& operator=(CPACSHeatExchangers&&) = delete;
    };
} // namespace generated
