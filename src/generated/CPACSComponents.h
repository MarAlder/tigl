...
namespace generated
{
    ...
    public:
        ...
        TIGL_EXPORT virtual ~CPACSComponents();

        TIGL_EXPORT CCPACSGenericSystem* GetParent();

        TIGL_EXPORT const CCPACSGenericSystem* GetParent() const;
    ...
    private:
        ...
        CPACSComponents& operator=(const CPACSComponents&) = delete;

        CPACSComponents(CPACSComponents&&) = delete;
        CPACSComponents& operator=(CPACSComponents&&) = delete;
    };
} // namespace generated
