...
namespace generated
{
    ...
    {
    public:
        TIGL_EXPORT CPACSBatteries(CPACSSystemElements* parent, CTiglUIDManager* uidMgr);

        TIGL_EXPORT virtual ~CPACSBatteries();
    ...
    protected:
        ...
        std::vector<std::unique_ptr<CPACSBattery>> m_batterys;

    private:
        CPACSBatteries(const CPACSBatteries&) = delete;
        CPACSBatteries& operator=(const CPACSBatteries&) = delete;

        CPACSBatteries(CPACSBatteries&&) = delete;
        CPACSBatteries& operator=(CPACSBatteries&&) = delete;
    };
} // namespace generated
