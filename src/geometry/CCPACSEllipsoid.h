...
#ifndef CCPACSELLIPSOID_H
#define CCPACSELLIPSOID_H

#include "generated/CPACSEllipsoid.h"

namespace tigl
{

class CCPACSEllipsoid : public generated::CPACSEllipsoid
{
public:
